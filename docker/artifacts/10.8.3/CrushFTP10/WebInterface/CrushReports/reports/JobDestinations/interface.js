...
crushReports.reports.JobDestinations = function(data, tpl) {
    ...
    var icon = "fa-clock-o";
    var title = "Job Destinations";
    var desc = "This report provides summary of all job destinations";
    ...
    function processData(_data) {
        ...
        $(_data).each(function() {
            ...
            var tasks = $(this).find("tasks_subitem");
            ...
            items.push({
                ...
                taskNames: crushFTPTools.xmlEncode(taskNames.join(","))
            });
    ...
    if (hasData) {
        $('#exportAsXLS').unbind().click(function() {
            ...
            function addType(data, type) {
                ...
                var tableRecords = [];
                var defaultRow = ["Job Name", "Type", "Next Run", "Enabled", "Notes", "Tasks"];
                ...
                for (var i = 0; i < data.items.length; i++) {
                    ...
                    row.push(crushFTPTools.decodeXML(curFile.taskNames));
