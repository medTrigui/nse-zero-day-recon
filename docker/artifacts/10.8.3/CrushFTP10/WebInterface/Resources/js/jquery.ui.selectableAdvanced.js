 ...
 */
/*
 * Modified by : Vipul Limbachiya for Crush FTP on 8th of April 2012
    ...
    $.widget('ui.selectableAdvanced', $.ui.mouse, {
        ...
        _init: function () {
            ...
            this.element.bind('mousedown.selectable', function (event) {
                ...
                if (!self.options.disabled) self.currentFocus.addClass('ui-state-focus-c');
            }).bind('blur.selectable', function () {
                if (!self.options.disabled) self.currentFocus.removeClass('ui-state-focus-c');
        ...
        _select: function (event, item) {
            ...
            this.previousFocus.removeClass('ui-state-focus-c');
            this.currentFocus.addClass('ui-state-focus-c');
        ...
        select: function (item) {
            ...
            item.each(function (i) {
                if (i == 0) { //Setting the focus on the first item in the list
                    ...
                    self.previousFocus.removeClass('ui-state-focus-c');
                    self.currentFocus.addClass('ui-state-focus-c');
                }
